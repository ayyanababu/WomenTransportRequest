define(function(require) {
  ...
  getContents: function () {
    ...
    for (var i = 0; i < option.length; i++){
      ...
      value.push(
        React.createElement("div", {className: "list", key: i, onClick: this.checkMark.bind(this,i)}, 
          React.createElement("div", {className: "listtitle"}, " ", option[i].value), 
  ...
  render: function () {
    ...
    return(
      React.createElement("div", {className: "gclass listContainer"}, 
        React.createElement("input", {className: className, id: "searchid", type: "search", placeholder: "Search", onChange: this.searchText}), 
      this.getContents()
      )
      );
    }
