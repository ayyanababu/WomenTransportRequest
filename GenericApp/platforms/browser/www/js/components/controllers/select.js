define(function(require) {
  ...
  var select = React.createClass ({displayName: "select",
    ...
    render: function() {
        return(
          React.createElement(SelectList, {options: this.props.options, defaultvalue: this.props.defaultvalues, onSelected: this.selectedValue, isSingle: this.props.isSingleSelect})
          );
    }
  });
