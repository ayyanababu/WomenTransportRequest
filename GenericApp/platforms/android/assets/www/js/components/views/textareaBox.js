  ...
  propTypes: {
    ...
    return (
          React.createElement("div", {className: "inputBox"}, 
            ...
            React.createElement("textarea", {name: "description", maxLength: fieldLimit, className: className, id: this.props.id, onChange: this._handleChange, onBlur: this._save, value: value})
          )
          );
      }
    });
