           ...
           if(this.state.selectedbutton === 1){
            ...
            return (
                React.createElement("div", {className: "inputBox"}, 
                  ...
                  React.createElement("div", {className: "toggle_button_container"}, 
                    React.createElement("button", {className: firstButtonClassName, onClick: this.onToggleButtonSegmentClick}, (this.props.options.length >= 2) ? this.props.options[0].value : "YES"), 
                    React.createElement("button", {className: secondButtonClassName, onClick: this.onToggleButtonSegmentClick}, (this.props.options.length >= 2) ? this.props.options[1].value : "NO")
                  )
                )
            );
        }
