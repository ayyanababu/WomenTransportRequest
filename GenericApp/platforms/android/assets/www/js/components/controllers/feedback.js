define(function(require){
  ...
  _onBackButtonClick:function(){
    ...
    if(feedbackObj)
    {
      ...
      NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "clear_data", buttons: msgButtons, onMsgClick: this._clearData}));
    }
    else
    {
  ...
  _onSubmitSuccess: function() {
      NavigationActions.removePopup();
      NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "feedback_success", buttons: msgButtonsArray, onMsgClick: this._onFeedbackSuccessMessage}));
  },
  _onSubmit:function()
  {
      var isEmpty = false;
  ...
  _onSelect: function() {
    ...
    var content= React.createElement(Select, {options: countries, isSingleSelect: isSingleSelect, onSave: this._onSave, id: "primary_location"})
    var controllerData = {
  ...
  getContent: function () {
    ...
    if(!feedbackObj)
    {
        actions.getFormData();
        return(
          React.createElement("div", {className: "gclass form"}, 
    ...
    return(
      React.createElement("div", {className: "gclass form"}, 
        React.createElement(TextArea, {name: "feedback_title", isRequired: true, limit: 2000, onSave: this._onSave, id: "feedback_title", defaultvalue: feedbackObj["feedback_title"]}), 
        React.createElement(SelectBox, {name: "primary_location", isRequired: true, onSelectBoxClick: this._onSelect, id: "primary_location", defaultvalues: [feedbackObj["primary_location"]]}), 
        React.createElement(ToggleButton, {name: "receive_update", isRequired: true, options: [{"key":"1","value":"Yes"},{"key":"2","value":"No"}], id: "receive_update", onSave: this._onSave, defaultvalue: feedbackObj["receive_update"]}), 
        React.createElement("div", {className: className}, 
          React.createElement(TextBox, {name: "feedback_name", isRequired: true, id: "feedback_name", onSave: this._onSave, defaultvalue: feedbackObj["feedback_name"]}), 
          React.createElement(TextBox, {name: "company_name", id: "company_name", onSave: this._onSave, defaultvalue: feedbackObj["company_name"]}), 
          React.createElement(TextBox, {name: "email_address", isRequired: true, id: "email_address", onSave: this._onSave, defaultvalue: feedbackObj["email_address"]}), 
          React.createElement(TextBox, {name: "contact_number", isRequired: true, id: "contact_number", onSave: this._onSave, defaultvalue: feedbackObj["contact_number"]})
        )
      )
    );
  }
