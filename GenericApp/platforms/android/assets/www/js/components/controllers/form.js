define(function (require) {
  ...
  var Form = React.createClass ({displayName: "Form",
      ...
      render: function () {
          ...
          return (
              React.createElement("div", {className: "gclass form", id: id}, 
                content
              )
          );
      },
      ...
      _submitFormData: function(formAction)
      {
          ...
          var onSubmit = function(data)
          {
              ...
              {
                NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "submission_success", buttons: msgButtonsArray, onMsgClick: that._onSubmitSuccess}));
              }
              else
              {
                NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "save_draft_success", buttons: msgButtonsArray, onMsgClick: that._onSubmitSuccess}));
              }
          }
      ...
      _onRightButtonClick:function()
      {
          ...
          if(isEmpty)
          {
            ...
            NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "mandatory_field", buttons: msgButtonsArray, onMsgClick: this._onCancel}));
            return;
          }
          ...
          else
          {
            ...
            NavigationActions.presentPopup(React.createElement(Confirm, {buttons: buttonArray, onAction: this._onActionClick, onCancel: this._onCancel}));
        }
      },
      _onComponentSave:function(id,value)
      {
          if(value !== undefined)
          {
              ...
              if(!content[id])
              {
                  NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "internal_error", buttons: msgButtonsArray, onMsgClick: this._onCancel}));
                  return;
              }
      ...
      _onSelectBoxClick:function(key,options)
      {
          ...
          {
            NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "field_not_found", buttons: msgButtonsArray, onMsgClick: this._onCancel}));
            return;
          }
          ...
          if(element.resource.source==="form")
          {
              ...
              var selectContent= React.createElement(Select, {options: options, isSingleSelect: isSingleSelect, onSave: this._onComponentSave, defaultvalues: defaultArray, id: key, key: key})
              var controllerData = {
              ...
              for(var i=0;i<parameters.length;i++)
              {
                  ...
                  if(valueObj)
                  {
                      ...
                      }else if(refValue === "stored_value")
                      {
                        ...
                        NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: message, buttons: msgButtonsArray, onMsgClick: this._onCancel}));
                        return;
                      }
              ...
              var gotResourceData=function(data)
              {
                  ...
                  defaultArray  = getSelectedLOVS(options,defaultArray);
                  var selectContent= React.createElement(Select, {options: options, isSingleSelect: isSingleSelect, onSave: that._onComponentSave, defaultvalues: defaultArray, id: key, key: key})
                  var controllerData = {
                    title:getString("select"),
                    content:selectContent,
                    leftButtonName:"Back",
      ...
      getContent:function (id,childId,rowId)
      {
          ...
          return {content:React.createElement(Loader, null)};
      },
          ...
          for(var i=0;i<keys.length;i++)
          {
              ...
              switch (element.fieldtype) {
                ...
                case constants.Dropdown:
                {
                    ...
                    if(options && options instanceof Array && options.length>0)
                    {
                        if(element.resource.source==="form" && isSingleSelect && options.length < 5)
                        {
                            if(options.length==2)
                            {
                                contentUI.push(React.createElement(ToggleButton, {name: element.label, isRequired: isRequired, options: options, onSave: this._onComponentSave, defaultvalue: value, id: key, key: key}))

                            }else if (options.length < 5) {

                                contentUI.push(React.createElement(RadioGroup, {name: element.label, isRequired: isRequired, options: options, onSave: this._onComponentSave, defaultchecked: value, id: key, key: key}))
                            }
                            ...
                            {
                                contentUI.push(React.createElement(CheckGroup, {name: element.label, isRequired: isRequired, options: options, onSave: this._onComponentSave, defaultchecked: defaultArray, id: key, key: key}))

                            }else {

                              contentUI.push(React.createElement(SelectBox, {name: element.label, isRequired: isRequired, onSelectBoxClick: this._onSelectBoxClick, defaultvalues: defaultArray, id: key, key: key}));
                            }
                        }
                ...
                case constants.Calendar:
                {
                  ...
                  contentUI.push(React.createElement(Calendar, {name: element.label, isRequired: isRequired, onSave: this._onComponentSave, defaultdate: date, defaulttime: time, id: key, key: key}));
                  break;
                }
                ...
                case constants.Attachment:
                {
                    ...
                    contentUI.push(React.createElement(Attach, {name: element.label, isRequired: isRequired, onSave: this._onComponentSave, defaultvalue: defaultvalues, id: key, key: key}));
                    break;
                }
                default:
                {
                   if(childId)
                  {
                    contentUI.push(React.createElement(TextBox, {name: element.label, isRequired: isRequired, onSave: this._onComponentSave, defaultvalue: value, id: key, key: key}));
                  }
                   else {
                    contentUI.push(React.createElement(TextArea, {name: element.label, isRequired: isRequired, onSave: this._onComponentSave, defaultvalue: value, id: key, key: key}));
                   }
                }
              }
          }
