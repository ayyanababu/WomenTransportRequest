  ...
  var grid = React.createClass({displayName: "grid",
    ...
    _onNext:function()
    {
        ...
        if(!selectedValue)
        {
          ...
          NavigationActions.presentPopup(React.createElement(Msg, {msgLabel: "category_not_selected", buttons: msgButton, onMsgClick: this._clearData}));
        }
        else
        {
          var content =  React.createElement(Form, {id: this.props.id, potentialLov: selectedValue});
    ...
    getContent:function(){
        ...
        var content = this.props.items.map(function(name,i)
        {
          ...
          return (React.createElement("div", {key: i, className: className, onClick: that._onClick.bind(that, name)}, 
